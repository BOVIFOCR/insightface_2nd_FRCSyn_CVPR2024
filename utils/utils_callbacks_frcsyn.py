...
from eval.loader_BUPT import Loader_BUPT
import pickle
...
class CallBackVerification(object):
    ...
    def __init__(self, val_targets, rec_prefix, summary_writer=None, image_size=(112, 112), wandb_logger=None, cfg=None):
        ...
        self.cfg = cfg
        if self.rank is 0:
            self.init_dataset(val_targets=val_targets, data_dir=rec_prefix, image_size=image_size, cfg=self.cfg)
