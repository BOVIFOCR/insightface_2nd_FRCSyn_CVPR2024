...
if uname.nodename == 'duo':
    ...
    config.rec = ['/datasets2/2nd_frcsyn_cvpr2024/datasets/synthetic/IDiff-Face/ca-cpd25-synthetic-uniform-10050',
                  '/datasets2/2nd_frcsyn_cvpr2024/datasets/synthetic/dcface/dcface_0.5m_oversample_xid/record/imgs']      # duo
    ...
    config.rec = ['/groups/unico/SDFR_at_FG2024/datasets/synthetic/IDiff-Face_ICCV2023/ca-cpd25-synthetic-uniform-10050',
                  '/groups/unico/2nd_frcsyn_cvpr2024/datasets/synthetic/dcface/dcface_0.5m_oversample_xid/record/imgs']
