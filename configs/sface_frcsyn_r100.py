...
if uname.nodename == 'duo':
    ...
    config.rec = ['/datasets2/2nd_frcsyn_cvpr2024/datasets/synthetic/SFace/data/fboutros/SFace/sg2cond_aligned']      # duo
    ...
    config.rec = ['/groups/unico/2nd_frcsyn_cvpr2024/datasets/synthetic/SFace/data/fboutros/SFace/sg2cond_aligned']
