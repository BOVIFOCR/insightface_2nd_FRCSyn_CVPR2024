...
if uname.nodename == 'duo':
    ...
    config.rec = ['/datasets2/2nd_frcsyn_cvpr2024/datasets/synthetic/SYNFace/CASIA-Generated-10k-100-01-MixID-Align']      # duo
    ...
    config.rec = ['/groups/unico/2nd_frcsyn_cvpr2024/datasets/synthetic/SYNFace/CASIA-Generated-10k-100-01-MixID-Align']
