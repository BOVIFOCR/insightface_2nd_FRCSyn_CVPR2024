...
if uname.nodename == 'duo':
    ...
    config.rec = '/datasets2/2nd_frcsyn_cvpr2024/datasets/synthetic/dcface/dcface_0.5m_oversample_xid/imgs_outliersRemoved_keptSamples_metric=cosine_2d_thresh=0.4'      # duo
